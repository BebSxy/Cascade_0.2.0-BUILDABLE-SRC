...
extends Button {
    ...
    public boolean isInsideCopy(int mouseX, int mouseY) {
        return ColorButton.mouseOver((int)this.x + 1, (int)this.y + 113, (int)(this.x + 1.0f) + Cascade.textManager.getStringWidth("Copy"), (int)(this.y + 112.0f) + Cascade.textManager.getFontHeight(), mouseX, mouseY);
    }

    public boolean isInsidePaste(int mouseX, int mouseY) {
        return ColorButton.mouseOver((int)this.x + 30, (int)this.y + 113, (int)(this.x + 30.0f) + Cascade.textManager.getStringWidth("Paste"), (int)(this.y + 112.0f) + Cascade.textManager.getFontHeight(), mouseX, mouseY);
    }
