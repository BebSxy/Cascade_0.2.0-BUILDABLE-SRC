...
extends Module {
    ...
    public void onUpdate() {
        ...
        if (Avoid.mc.theWorld.getBlockState(pos).getBlock() == Blocks.fire && this.fire.getValue().booleanValue()) {
            MovementUtil.setMotion(0.0, 0.0, 0.0);
        }
        if (Avoid.mc.theWorld.getBlockState(pos).getBlock() == Blocks.cactus && this.cactus.getValue().booleanValue()) {
            MovementUtil.setMotion(0.0, 0.0, 0.0);
        }
    }
}
