...
extends Module {
    ...
    public void onMove(MoveEvent event) {
        if (!MovementUtil.isMoving() || this.isDisabled() || Strafe.mc.thePlayer.isElytraFlying()) {
            return;
        }
        ...
        if (this.stage == 1 && MovementUtil.isMoving()) {
            ...
            if ((Strafe.mc.theWorld.getCollisionBoxes(null, Strafe.mc.thePlayer.getEntityBoundingBox().offset(0.0, Strafe.mc.thePlayer.motionY, 0.0)).size() > 0 || Strafe.mc.thePlayer.isCollidedVertically) && this.stage > 0) {
