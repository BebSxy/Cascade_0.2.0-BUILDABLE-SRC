...
extends Module {
    ...
    public void onMove(MoveEvent e) {
        ...
        if (LongJump.mc.thePlayer != mc.getRenderViewEntity()) {
            return;
        }
        ...
        if (this.stage == 1 && MovementUtil.isMoving()) {
            ...
            if (LongJump.mc.theWorld.getCollisionBoxes((Entity)LongJump.mc.thePlayer, LongJump.mc.thePlayer.getEntityBoundingBox().offset(0.0, LongJump.mc.thePlayer.motionY, 0.0)).size() > 0 || LongJump.mc.thePlayer.isCollidedVertically) {
                this.stage = 1;
            }
        ...
        float moveForward = LongJump.mc.thePlayer.movementInput.moveForward;
