...
extends Module {
    ...
    public void onUpdate() {
        ...
        if (AntiVoid.mc.thePlayer.noClip || AntiVoid.mc.thePlayer.posY > (double)this.distance.getValue().intValue() || AntiVoid.mc.thePlayer.isRiding()) {
            return;
        }
        RayTraceResult trace = AntiVoid.mc.theWorld.rayTraceBlocks(AntiVoid.mc.thePlayer.getPositionVector(), new Vec3d(AntiVoid.mc.thePlayer.posX, 0.0, AntiVoid.mc.thePlayer.posZ), false, false, false);
