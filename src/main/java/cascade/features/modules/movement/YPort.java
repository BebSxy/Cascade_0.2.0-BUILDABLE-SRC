...
extends Module {
    ...
    public void onUpdate() {
        ...
        if (!YPort.mc.thePlayer.isOnLadder() || YPort.mc.thePlayer.isInWater() || YPort.mc.thePlayer.isInLava()) {
    ...
    void handleYPortSpeed() {
        ...
        if (YPort.mc.thePlayer.onGround) {
            ...
            RayTraceResult trace = YPort.mc.theWorld.rayTraceBlocks(YPort.mc.thePlayer.getPositionVector(), new Vec3d(YPort.mc.thePlayer.posX, YPort.mc.thePlayer.posY - 5.0, YPort.mc.thePlayer.posZ), false, false, false);
