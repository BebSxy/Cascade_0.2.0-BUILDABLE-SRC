...
extends Module {
    ...
    public void onMove(MoveEvent e) {
        ...
        if (EntityUtil.isInLiquid() && !Cascade.moduleManager.isModuleEnabled("FastMotion")) {
            ...
            if (FastSwim.mc.thePlayer.isInLava()) {
    ...
    boolean shouldBoost() {
        return this.kbBoost.getValue() != false && Cascade.packetManager.caughtPExplosion() && FastSwim.mc.thePlayer.getDistance(Cascade.packetManager.pExplosion().getX(), Cascade.packetManager.pExplosion().getY(), Cascade.packetManager.pExplosion().getZ()) <= this.range.getValue() && !FastSwim.mc.thePlayer.onGround;
    }
}
