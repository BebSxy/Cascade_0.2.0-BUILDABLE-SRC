...
extends Module {
    ...
    public void onDisable() {
        if (Step.mc.thePlayer.isRiding()) {
            Step.mc.thePlayer.getRidingEntity().stepHeight = 1.0f;
        } else {
    ...
    public void onUpdate() {
        ...
        if (Step.mc.thePlayer.isRiding() && this.entityStep.getValue().booleanValue()) {
            Step.mc.thePlayer.getRidingEntity().stepHeight = 2.0f;
        }
    }
