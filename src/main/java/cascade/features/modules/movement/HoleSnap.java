...
extends Module {
    ...
    public void onUpdate() {
        ...
        if (HoleSnap.mc.theWorld.getBlockState(this.holes.pos1).getBlock() != Blocks.air) {
            this.disable();
            return;
        }
        BlockPos it = this.holes.pos1;
        Vec3d playerPos = HoleSnap.mc.thePlayer.getPositionVector();
        Vec3d targetPos = new Vec3d((double)it.getX() + 0.5, HoleSnap.mc.thePlayer.posY, (double)it.getZ() + 0.5);
