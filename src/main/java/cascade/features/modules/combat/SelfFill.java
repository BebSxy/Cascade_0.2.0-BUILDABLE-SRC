...
extends Module {
    ...
    public void onEnable() {
        ...
        if (SelfFill.mc.theWorld.checkBlockCollision(SelfFill.mc.thePlayer.boundingBox.addCoord(0.0, 1.0, 0.0)) || !SelfFill.mc.theWorld.getBlockState((BlockPos)this.startPos).getBlock().blockMaterial.isReplaceable()) {
            return;
        }
    }
    ...
    public boolean shouldReturn() {
        return PlayerUtil.isClipping() || this.startPos.getY() > 255 || !SelfFill.mc.thePlayer.onGround;
    }
