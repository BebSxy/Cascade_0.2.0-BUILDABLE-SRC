...
extends Module {
    ...
    public void onPacketReceive(PacketEvent.Receive e) {
        ...
        if (this.predict.getValue().booleanValue() && e.getPacket() instanceof SPacketBlockChange) {
            ...
            if (p.blockState.getBlock() == Blocks.air && FeetPlace.mc.thePlayer.getDistance((double)p.blockPosition.x, (double)p.blockPosition.y, (double)p.blockPosition.z) < 1.75 && this.predictBpt.getValue() <= this.packets) {
    ...
    private void doFeetPlace() {
        ...
        if (PlayerUtil.isChestBelow()) {
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(1.0, 0.0, 0.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(-1.0, 0.0, 0.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(0.0, 0.0, 1.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(0.0, 0.0, -1.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(1.0, 1.0, 0.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(-1.0, 1.0, 0.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(0.0, 1.0, 1.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(0.0, 1.0, -1.0));
        } else {
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(0.0, -1.0, 0.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(1.0, -1.0, 0.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(-1.0, -1.0, 0.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(0.0, -1.0, 1.0));
            this.offsets.add(FeetPlace.mc.thePlayer.getPositionVector().addVector(0.0, -1.0, -1.0));
        ...
        for (Vec3d vec3d : this.offsets) {
            ...
            if (!FeetPlace.mc.theWorld.getBlockState(pos).getMaterial().isReplaceable()) continue;
