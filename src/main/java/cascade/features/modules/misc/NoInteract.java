...
extends Module {
    ...
    public void onPacketSend(PacketEvent.Send e) {
        ...
        try {
            if (e.getPacket() instanceof CPacketPlayerTryUseItemOnBlock && !NoInteract.mc.thePlayer.isSneaking() && NoInteract.mc.gameSettings.keyBindUseItem.getIsKeyPressed() && (InventoryUtil.heldItem(Items.experience_bottle, InventoryUtil.Hand.Both) || InventoryUtil.heldItem(Items.golden_apple, InventoryUtil.Hand.Both) || InventoryUtil.heldItem(Items.CHORUS_FRUIT, InventoryUtil.Hand.Both) || InventoryUtil.heldItem((Item)Items.bow, InventoryUtil.Hand.Both) || InventoryUtil.heldItem(Items.writable_book, InventoryUtil.Hand.Both) || InventoryUtil.heldItem(Items.written_book, InventoryUtil.Hand.Both) || InventoryUtil.heldItem((Item)Items.potionitem, InventoryUtil.Hand.Both) || this.pickaxe.getValue().booleanValue() && InventoryUtil.heldItem(Items.diamond_pickaxe, InventoryUtil.Hand.Main))) {
                ...
                if (NoInteract.mc.theWorld.getBlockState(NoInteract.mc.objectMouseOver.getBlockPos()).getBlock() == Blocks.anvil) {
                    e.setCanceled(true);
                    mc.getNetHandler().addToSendQueue((Packet)new CPacketPlayerTryUseItem(EnumHand.MAIN_HAND));
                }
            }
    ...
    public void onBlockInteract(PlayerInteractEvent.RightClickBlock e) {
        ...
        if ((NoInteract.mc.theWorld.getBlockState(e.getPos()).getBlock() == Blocks.anvil || NoInteract.mc.theWorld.getBlockState(e.getPos()).getBlock() == Blocks.ender_chest) && !NoInteract.mc.thePlayer.isSneaking() && NoInteract.mc.gameSettings.keyBindUseItem.getIsKeyPressed() && (InventoryUtil.heldItem(Items.experience_bottle, InventoryUtil.Hand.Both) || InventoryUtil.heldItem(Items.golden_apple, InventoryUtil.Hand.Both) || InventoryUtil.heldItem(Items.CHORUS_FRUIT, InventoryUtil.Hand.Both) || InventoryUtil.heldItem((Item)Items.bow, InventoryUtil.Hand.Both) || InventoryUtil.heldItem(Items.writable_book, InventoryUtil.Hand.Both) || InventoryUtil.heldItem(Items.written_book, InventoryUtil.Hand.Both) || InventoryUtil.heldItem((Item)Items.potionitem, InventoryUtil.Hand.Both) || this.pickaxe.getValue().booleanValue() && InventoryUtil.heldItem(Items.diamond_pickaxe, InventoryUtil.Hand.Main))) {
            e.setCanceled(true);
            mc.getNetHandler().addToSendQueue((Packet)new CPacketPlayerTryUseItem(EnumHand.MAIN_HAND));
        }
    }
