...
implements Util {
    public static boolean isMoving() {
        return (double)MovementUtil.mc.thePlayer.moveForward != 0.0 || (double)MovementUtil.mc.thePlayer.moveStrafing != 0.0;
    }

    public static boolean anyMovementKeys() {
        return MovementUtil.mc.thePlayer.movementInput.forwardKeyDown || MovementUtil.mc.thePlayer.movementInput.backKeyDown || MovementUtil.mc.thePlayer.movementInput.leftKeyDown || MovementUtil.mc.thePlayer.movementInput.rightKeyDown || MovementUtil.mc.thePlayer.movementInput.jump || MovementUtil.mc.thePlayer.movementInput.sneak;
    }
    ...
    public static boolean isInMovementDirection(double x, double y, double z) {
        if (MovementUtil.mc.thePlayer.motionX != 0.0 || MovementUtil.mc.thePlayer.motionZ != 0.0) {
            BlockPos movingPos = new BlockPos((Entity)MovementUtil.mc.thePlayer).add(MovementUtil.mc.thePlayer.motionX * 10000.0, 0.0, MovementUtil.mc.thePlayer.motionZ * 10000.0);
            BlockPos antiPos = new BlockPos((Entity)MovementUtil.mc.thePlayer).add(MovementUtil.mc.thePlayer.motionX * -10000.0, 0.0, MovementUtil.mc.thePlayer.motionY * -10000.0);
    ...
    public static void setMotion(double x, double y, double z) {
        if (MovementUtil.mc.thePlayer != null) {
            if (MovementUtil.mc.thePlayer.isRiding()) {
                MovementUtil.mc.thePlayer.ridingEntity.motionX = x;
                MovementUtil.mc.thePlayer.ridingEntity.motionY = y;
                MovementUtil.mc.thePlayer.ridingEntity.motionZ = x;
            } else {
    ...
    public static double[] forward(double speed) {
        ...
        float yaw = Minecraft.getMinecraft().thePlayer.prevRotationYaw + (Minecraft.getMinecraft().thePlayer.rotationYaw - Minecraft.getMinecraft().thePlayer.prevRotationYaw) * Minecraft.getMinecraft().getRenderPartialTicks();
        if (forward != 0.0f) {
            if (side > 0.0f) {
