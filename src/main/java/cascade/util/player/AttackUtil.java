...
implements Util {
    public static boolean isInterceptedByCrystal(BlockPos pos) {
        for (Entity entity : AttackUtil.mc.theWorld.loadedEntityList) {
            if (!(entity instanceof EntityEnderCrystal) || entity == AttackUtil.mc.thePlayer || entity instanceof EntityItem || !new AxisAlignedBB(pos).intersectsWith(entity.getEntityBoundingBox())) continue;
            return true;
        }
        return false;
    }
    ...
    public static boolean isInterceptedByOther(BlockPos pos) {
        for (Entity entity : AttackUtil.mc.theWorld.loadedEntityList) {
            if (entity instanceof EntityEnderCrystal || entity instanceof EntityItem || !new AxisAlignedBB(pos).intersectsWith(entity.getEntityBoundingBox())) continue;
            return true;
        }
        return false;
    }
