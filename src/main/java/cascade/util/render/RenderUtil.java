...
implements Util {
    ...
    public static void drawBlockOutline(BlockPos pos, Color color, float linewidth, boolean air) {
        IBlockState iblockstate = RenderUtil.mc.theWorld.getBlockState(pos);
        if ((air || iblockstate.getMaterial() != Material.air) && RenderUtil.mc.theWorld.getWorldBorder().contains(pos)) {
            ...
            RenderUtil.drawBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtil.mc.theWorld, pos).grow((double)0.002f).offset(-interp.xCoord, -interp.yCoord, -interp.zCoord), color, linewidth);
        }
    }
    ...
    public static void drawBoxESP(BlockPos pos, Color color, float lineWidth, boolean outline, boolean box, int boxAlpha) {
        ...
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtil.mc.getRenderManager().viewerPosX, bb.minY + RenderUtil.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtil.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtil.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtil.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtil.mc.getRenderManager().viewerPosZ))) {
            ...
            GL11.glHint((int)3154, (int)4354);
            GL11.glLineWidth((float)lineWidth);
            double dist = RenderUtil.mc.thePlayer.getDistance((double)((float)pos.getX() + 0.5f), (double)((float)pos.getY() + 0.5f), (double)((float)pos.getZ() + 0.5f)) * 0.75;
            if (box) {
    ...
    public static void drawText(BlockPos pos, String text) {
        GlStateManager.pushMatrix();
        RenderUtil.glBillboardDistanceScaled((float)pos.getX() + 0.5f, (float)pos.getY() + 0.5f, (float)pos.getZ() + 0.5f, (EntityPlayer)RenderUtil.mc.thePlayer, 1.0f);
        GlStateManager.disableDepth();
    ...
    public static void drawOutlinedBlockESP(BlockPos pos, Color color, float linewidth) {
        IBlockState iblockstate = RenderUtil.mc.theWorld.getBlockState(pos);
        Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil.mc.thePlayer, mc.getRenderPartialTicks());
        RenderUtil.drawBoundingBox(iblockstate.getSelectedBoundingBox((World)RenderUtil.mc.theWorld, pos).grow((double)0.002f).offset(-interp.xCoord, -interp.yCoord, -interp.zCoord), linewidth, ColorUtil.toRGBA(color));
    }
    ...
    public static AxisAlignedBB getBoundingBox(BlockPos blockPos) {
        return RenderUtil.mc.theWorld.getBlockState(blockPos).getBoundingBox((IBlockAccess)RenderUtil.mc.theWorld, blockPos).offset(blockPos);
    }
    ...
    public static void glBillboard(float x, float y, float z) {
        ...
        GlStateManager.rotate((float)(-RenderUtil.mc.thePlayer.rotationYaw), (float)0.0f, (float)1.0f, (float)0.0f);
        GlStateManager.rotate((float)RenderUtil.mc.thePlayer.rotationPitch, (float)(RenderUtil.mc.gameSettings.thirdPersonView == 2 ? -1.0f : 1.0f), (float)0.0f, (float)0.0f);
    ...
    public static void drawBlockOutline2(BlockPos pos, Color color, float linewidth, boolean air, double growAmt) {
        ...
        if ((air || iblockstate.getMaterial() != Material.air) && RenderUtil.mc.theWorld.getWorldBorder().contains(pos)) {
            assert (RenderUtil.mc.renderViewEntity != null);
            Vec3d interp = EntityUtil.interpolateEntity(RenderUtil.mc.renderViewEntity, mc.getRenderPartialTicks());
            RenderUtil.drawBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtil.mc.theWorld, pos).grow(-growAmt).offset(-interp.xCoord, -interp.yCoord, -interp.zCoord), color, linewidth);
        }
    }
    ...
    public static void drawBlockCrossedESP(BlockPos pos, Color color, float linewidth, boolean air) {
        ...
        if ((air || iblockstate.getMaterial() != Material.air) && RenderUtil.mc.theWorld.getWorldBorder().contains(pos)) {
            assert (RenderUtil.mc.renderViewEntity != null);
            Vec3d interp = EntityUtil.interpolateEntity(RenderUtil.mc.renderViewEntity, mc.getRenderPartialTicks());
            RenderUtil.drawBlockCrossed(iblockstate.getSelectedBoundingBox((World)RenderUtil.mc.theWorld, pos).grow((double)0.002f).offset(-interp.xCoord, -interp.yCoord, -interp.zCoord), color, linewidth);
        }
    }
    ...
    public static void drawBlockFlucESP(BlockPos pos, Color color, float linewidth, boolean air) {
        ...
        if ((air || iblockstate.getMaterial() != Material.air) && RenderUtil.mc.theWorld.getWorldBorder().contains(pos)) {
            assert (RenderUtil.mc.renderViewEntity != null);
            Vec3d interp = EntityUtil.interpolateEntity(RenderUtil.mc.renderViewEntity, mc.getRenderPartialTicks());
            RenderUtil.drawBlockFluctuate(iblockstate.getSelectedBoundingBox((World)RenderUtil.mc.theWorld, pos).grow((double)0.002f).offset(-interp.xCoord, -interp.yCoord, -interp.zCoord), color, linewidth);
        }
    }
    ...
    public static void drawBlockOutlineBB(AxisAlignedBB bb, Color color, float linewidth) {
        Vec3d interp = RenderUtil.interpolateEntity((Entity)RenderUtil.mc.thePlayer, mc.getRenderPartialTicks());
        RenderUtil.drawBlockOutline(bb.grow((double)0.002f).offset(-interp.xCoord, -interp.yCoord, -interp.zCoord), color, linewidth);
    }
    ...
    public static Entity getEntity() {
        return mc.getRenderViewEntity() == null ? RenderUtil.mc.thePlayer : mc.getRenderViewEntity();
    }
